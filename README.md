...
Experiment tracking defaults to **Databricks MLflow** (H2O still trains in
Airflow/host) — see `docs/databricks_experiment_tracking.md`. Compose-local
MLflow remains available by setting `MLFLOW_TRACKING_URI=http://mlflow:5000`.
