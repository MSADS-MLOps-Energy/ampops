...
from ampops.training import automl
from ampops.training.registry import register_champion
...
@dag(
    ...
    description="Clean, join, feature-engineer, AutoML search, and register the demand forecaster",
